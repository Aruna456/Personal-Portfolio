const FixedButton = () => {
  ...
  return (
    <div className="group">
      ...
      >
        <span className="absolute inset-0 rounded-xl  bg-gradient-to-r from-primary/40 to-primary  p-[2px] opacity-80  transition-opacity duration-500 group-hover:opacity-100"></span>
